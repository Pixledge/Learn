...
public class Item : MonoBehaviour
{
 ...
 //       print(remainColors.Count);
        ...
        else if ((LevelManager.THIS.target == Target.FLAG && (LevelManager.THIS.ingrTarget[0] == Flags.Flag1 || LevelManager.THIS.ingrTarget[0] == Flags.Flag2)) && UnityEngine.Random.Range(0, 30) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType && LevelManager.THIS.GetIngredients(0).Count < LevelManager.THIS.ingrCountTarget[0])
        {
            int i = 0;
                if (LevelManager.THIS.ingrTarget[i] == (Flags)i + 1 && LevelManager.THIS.ingrCountTarget[i] > 0 )
                {
        ...
        else if ((LevelManager.THIS.target == Target.FLAG && (LevelManager.THIS.ingrTarget[1] == Flags.Flag1 || LevelManager.THIS.ingrTarget[1] == Flags.Flag2)) && UnityEngine.Random.Range(0, 30) == 0 && square.row + 1 < LevelManager.THIS.maxRows && !onlyNONEType && LevelManager.THIS.GetIngredients(1).Count < LevelManager.THIS.ingrCountTarget[1])
        {
            int i = 1;
            if (LevelManager.THIS.ingrTarget[i] == (Flags)i + 1 && LevelManager.THIS.ingrCountTarget[i] > 0)
            {
