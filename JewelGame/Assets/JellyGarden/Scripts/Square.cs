...
public class Square : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (LevelManager.THIS.target == Target.FLAG && (LevelManager.THIS.ingrTarget[0] == Flags.Flag1 || LevelManager.THIS.ingrTarget[1] == Flags.Flag1 || LevelManager.THIS.ingrTarget[0] == Flags.Flag1 || LevelManager.THIS.ingrTarget[1] == Flags.Flag2))
            {
